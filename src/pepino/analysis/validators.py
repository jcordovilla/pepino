...
class UserAnalysisRequest(BaseModel):
    ...
    username: str = Field(
        ...
        min_length=1,
        max_length=100,
        description="Discord username or display name",
    )
...
class ChannelAnalysisRequest(BaseModel):
    ...
    channel_name: str = Field(
        ..., min_length=1, max_length=100, description="Discord channel name"
    )
    days: Optional[int] = Field(
        None, ge=1, le=365, description="Number of days to analyze"
    )
...
class TopicAnalysisRequest(BaseModel):
    ...
    channel_name: Optional[str] = Field(
        None, max_length=100, description="Channel name to analyze"
    )
    days: Optional[int] = Field(
        None, ge=1, le=365, description="Number of days to analyze"
    )
    ...
    min_topic_size: int = Field(
        5, ge=2, le=50, description="Minimum messages per topic"
    )
...
class TemporalAnalysisRequest(BaseModel):
    ...
    user_name: Optional[str] = Field(
        None, max_length=100, description="User name to analyze"
    )
    days: Optional[int] = Field(
        None, ge=1, le=365, description="Number of days to analyze"
    )
...
def validate_user_analysis_input(
    username: str, days: Optional[int] = None, **kwargs
) -> UserAnalysisRequest:
    """
...
def validate_channel_analysis_input(
    channel_name: str, days: Optional[int] = None, **kwargs
