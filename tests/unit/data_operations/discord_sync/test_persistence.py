...
from pepino.data_operations.discord_data import persistence
...
class TestSettingsIntegration:
    ...
    def test_default_db_path_from_settings_sync(self, sample_message_data):
        ...
        with patch(
            "pepino.data_operations.discord_data.persistence.DatabaseManager"
        ) as mock_db_manager:
            with patch(
                "pepino.data_operations.discord_data.persistence.MessageRepository"
            ) as mock_repo:
