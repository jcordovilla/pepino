...
class TestSyncManager:
    ...
    async def test_load_existing_data(self, sync_manager):
        ...
        with patch("pepino.data_operations.discord_sync.sync_manager.load_existing_data") as mock_load:
    ...
    async def test_save_sync_results(self, sync_manager):
        ...
        from pepino.data_operations.discord_sync.models import SyncLogEntry
        ...
        with patch("pepino.data.repositories.MessageRepository") as mock_message_repo:
            with patch("pepino.data.repositories.ChannelRepository") as mock_channel_repo:
                with patch("pepino.data.repositories.SyncRepository") as mock_sync_repo:
                    ...
                    mock_message_instance.bulk_insert_messages.assert_called_once_with(messages_data)
